/** Hafif, çizgisel SVG ikon seti (emoji yerine profesyonel görünüm). */
type IconProps = { className?: string };

const base = "h-6 w-6";

export function IconBeach({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 20h18" />
      <path d="M12 20V9" />
      <path d="M12 9c-3-3-7-2-8 1 3-1 6 0 8-1z" />
      <path d="M12 9c3-3 7-2 8 1-3-1-6 0-8-1z" />
...
export function IconCap({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" className={className}>
