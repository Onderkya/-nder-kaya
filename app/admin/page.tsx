...
export default async function AdminDashboard() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader title="Merhaba 👋" description="İşletmenin bugünkü özeti. Soldaki menüden her şeyi yönetebilirsin." />
            ...
            {attention.map((a) => (
              <li key={a.href}>
                <Link href={a.href} className="flex items-center gap-3 py-3 transition hover:opacity-80">
                  ...
                  <span className="shrink-0 text-[13.5px] font-semibold" style={{ color: "rgb(var(--primary))" }}>Git →</span>
                </Link>
              </li>
            ))}
          </ul>
